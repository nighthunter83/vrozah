...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'delivery_info'); ?>
		<?php echo $form->error($model,'delivery_info'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'order_items'); ?>
		<?php echo $form->textField($model,'order_items'); ?>
		<?php echo $form->error($model,'order_items'); ?>
	</div>
